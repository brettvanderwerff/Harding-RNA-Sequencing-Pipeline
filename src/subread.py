...
def get_subread():
    ...
    '''
    if not os.path.isdir('subread-1.6.2-Linux-x86_64'):
...
def exec_count(feature_counts_dir, bams_dir, annotations_dir, output_dir):
    ...
    subprocess.call(['./feature_counts.sh', feature_counts_dir, bams_dir, annotations_dir, output_dir])
