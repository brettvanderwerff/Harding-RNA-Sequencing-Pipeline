...
CONFIGURATION = {
    ...
    'fastqc_dir' : os.path.join(os.path.basename(__file__),
                                os.path.basename('FastQC'),
                                os.path.basename('fastqc')),
    'fastqc_output_dir' : source_folder + 'FastQC_output',
    'feature_counts_dir' : os.path.join(os.path.basename(__file__),
    ...
    'star_dir' : os.path.join(os.path.basename(__file__),
